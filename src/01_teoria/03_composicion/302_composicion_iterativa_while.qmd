...
## Limites de la composición secuencial y condicional {.center}

---

### Limites de la composición secuencial y condicional
...
Escribe programa Python que imprima por pantalla la siquiente frase **100 veces**:
...
Escribe programa Python que solicite un número entero al usuario y que imprima por pantalla la siquiente frase **tantas veces** como el número introducido:
...
- En Python, existe la **asignación aumentada**.
    ...
    - `count -= 1`: Equivale a `count = count - 1`
- **OtrosAtajo**: `*=` (producto), `/=` (división), `%=` (resto), `**=` (potencia)
...
- Los **acumuladores** tienen muchos usos más alla de **contar** las iteraciones de un bucle
