...
- Si queremos representar **todas las aulas** de la facultad, el problema se vuelve **inabarcarble**.
...
- Para marcar una **clase** como **dataclass**, simplemente hay que añadir el _decorador `@dataclasses.dataclass` antes de la definición de la clase.
