...
#### Técticas de codificación de una secuencia

- **Opión 1:** Cambiar el `for` por un `while` que recorra la lista hasta encontrar un **valor especial** que indique el final de la secuencia.
...
- **Opión 2:** Guardar en otra variable el **número de elementos válidos** de la lista.
...
- **Opión 3:** Devolver tanto la lista como el número de elementos válidos mediante un objeto.
...
- Esto nos permite usar listas **sin definir su tamaño** de antemano.
    ...
    - Procuraremos recurir a esto **sólo cuando sea necesario**.
...
- Una función `filtrar_por_nacimiento(alumnos, nacimiento)` que reciba una lista de alumnos y un año de nacimiento y devuelva una lista **nueva** que contenga sólo los alumnos nacidos en un año anterior o igual al año indicado.
...
- Esto es sólo la punta del iceberg de la _"gestión de errores y excepciones"_.
:::
