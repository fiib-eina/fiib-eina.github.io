...
- Una clase (_dataclass_) denominada `Complejo`
...
<!-- NOTE: Quito esta parte especificamente para ver si se les ocurre reutilizar. Al ser i/o no le voy a hacer un unittest o sea que da igual -->
...
**Pruebas:** Si ejecutas el código del fichero [`test_lista_complejos.py`](./tests/test_lisa_complejos.py), se harán pruebas de unidad de ese módulo.
