...
Escribe una función `inicializa_tablero` que genere un tablero de `n` filas y `n` columnas, haga `num_barcos` colocaciones aleatorias de barcos y devuelva el tablero resultando.
