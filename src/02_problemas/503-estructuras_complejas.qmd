...
### _Extra:_ `pintar_tablero`

Escribe una función `pintar_tablero` que reciba un tablero y lo imprima por pantalla. Usa el símbolo "X" para representar las celdas ocupadas por barcos y "." para representar las celdas vacías.
